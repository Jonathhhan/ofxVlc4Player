...
void ofVlcPlayer4Gui::drawHeaderSection(ofxVlc4Player & player, bool hasPlaylist) {
...
void ofVlcPlayer4Gui::handleKeyPressed(int key, ofxVlc4Player & player, ofxProjectM & projectM, bool projectMInitialized) {
...
bool ofVlcPlayer4Gui::shouldRenderVideoPreview() const {
